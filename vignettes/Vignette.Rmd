...
##---- 2.1. Change the Chr to numeric
#lines_GenMap$chr <- as.numeric(lines_GenMap$chr)
...
##---- 4.1. Change the Chr to numeric
generic_GenMap$chr <- as.numeric(generic_GenMap$chr)
