...
#' @docType data
#'
#' @usage data(lines_addEffects)
#'
#' @details The SNP effects came from a Bayesian model implemented using both traits together. A total of 10 chromosomes were simulated.
"lines_addEffects"
